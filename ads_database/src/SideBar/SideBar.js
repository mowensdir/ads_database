	...
	render() {
		return (
	        <div class="sidebar">
	          ...
	          <div id="results-content" class="results-content" if={this.state.searchItems.Drivers.length} >
		          <p>DRIVERS</p>
	          ...
	          <div id="results-content" class="results-content" if={this.state.searchItems.Services.length} >
	          	<p>SERVICES</p>
	          ...
	          <div id="results-content" class="results-content" if={this.state.searchItems.Files.length} >
		          <p>Files</p>
